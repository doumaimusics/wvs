    ...
    <div class="withdraw-top">
      <div class="body">
			...
			<div class="withdraw-arival">
				<span v-text="lang.actual">实际到账</span>
      ...
      <div class="withdraw-arival">
			...
			<div class="withdraw-arival" style="margin-top: 1px;">
				...
				<span style="float: right;" class="value">{{fee2}} %</span>
			</div>
			<div class="btn-row">
  ...
  export default {
    ...
    computed: {
      actual: function () {
        ...
        var val = 0;
        // if (moneyVal && moneyVal > this.fee2) {}
          val = ToMoney4((moneyVal - moneyVal * (this.fee2 / 100) ) / this.wvs_usdt);
